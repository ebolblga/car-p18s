...
const toPlate = (word: string) => {
    ...
    const toEng = (word) =>
        word.replace(/[авекмнорстух]/gi, (letter) => Map[letter])
    const toDigit = (word) =>
        word.replace(/[озчбд]/gi, (letter) => digitMap[letter])
...
<template>
    <div class="content-center text-center pt-[5vh]">
        ...
        <div
            class="inline-block absolute z-10 w-64 ml-8 mt-[-40px] text-sm font-light rounded-lg border shadow-sm text-gray-400 border-gray-600 bg-gray-800"
                        ...
                        <tr
                            ...
                            <td class="py-4 px-auto">
                                <a
                                    ...
                                    target="_blank"
                                    ><img :src="platesUrls[i]" :alt="plates[i]"
                                /></a>
                            </td>
                        </tr>
                    </tbody>
